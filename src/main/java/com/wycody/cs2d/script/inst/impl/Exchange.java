...
public interface Exchange {
    Function<Object,Object> exchangeFormatter = o -> "getExchangeOffer("+o+")";
    
    
    /**
     * Returns whether the specified grand exchange offer is sell (1) or buy (0).
     */
    Supplier<CallMethodInstruction> PUSH_ISSELL = () ->
     ...
     */
    Supplier<CallMethodInstruction> PUSH_OBJID = () ->
     ...
     */
    Supplier<CallMethodInstruction> PUSH_PRICE = () ->
     ...
     */
    Supplier<CallMethodInstruction> PUSH_COUNT = () ->
     ...
     */
    Supplier<CallMethodInstruction> PUSH_COMPLETECOUNT = () ->
     ...
     */
    Supplier<CallMethodInstruction> PUSH_COMPLETEGOLD = () ->
     ...
     */
    Supplier<CallMethodInstruction> PUSH_ISEMPTY = () ->
     ...
     */
    Supplier<CallMethodInstruction> PUSH_ISFINISHED = () ->
     ...
     */
    Supplier<CallMethodInstruction> PUSH_ISSUBMITTING = () ->

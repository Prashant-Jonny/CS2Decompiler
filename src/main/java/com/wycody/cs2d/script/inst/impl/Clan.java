...
public class Clan {
    public static final Function<Object,Object> memberFormatter = o -> "getActiveClanSettings().getMember("+o+")";
    public static final Function<Object,Object> banFormatter = o -> "getActiveClanSettings().getBan("+o+")";
    public static final Function<Object,Object> userFormatter = o -> "getActiveClanChannel().getUser("+o+")";
    
    /**
     * Sets the active clan settings to the guest clan. Returns 1 if the active clan settings was set, 0 otherwise.
     */
    public static Supplier<CallMethodInstruction> SETTINGS_SETGUEST = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> SETTINGS_SETMAIN = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> PUSH_SETTINGS_NAME = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> PUSH_SETTINGS_ALLOWNONMEMBERS = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> PUSH_SETTINGS_RANKTALK = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> PUSH_SETTINGS_RANKKICK = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> PUSH_SETTINGS_RANKLOOTSHARE = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> PUSH_SETTINGS_MEMBERCOUNT = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> PUSH_SETTINGS_MEMBER_NAME = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> PUSH_SETTINGS_MEMBER_RANK = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> PUSH_SETTINGS_BANCOUNT = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> PUSH_SETTINGS_BAN_NAME = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> PUSH_SETTINGS_MEMBER_VARBIT = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> PUSH_SETTINGS_OWNERSLOT = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> PUSH_SETTINGS_REPLACEMENTOWNERSLOT = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> PUSH_SETTINGS_MEMBER_SLOT = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> PUSH_SETTINGS_MEMBER_SORTEDSLOT = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> PUSH_SETTINGS_MEMBER_JOINDAY = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> CHANNEL_SETGUEST = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> CHANNEL_SETMAIN = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> PUSH_CHANNEL_NAME = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> PUSH_CHANNEL_RANKKICK = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> PUSH_CHANNEL_RANKTALK = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> PUSH_CHANNEL_USERCOUNT = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> PUSH_CHANNEL_USER_NAME = () ->
     ...
     * Returns the name of the user at the specified slot within the active clan channel.
     */
    public static Supplier<CallMethodInstruction> PUSH_CHANNEL_USER_RANK = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> PUSH_CHANNEL_USER_NODEID = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> CHANNEL_KICK_USER = () -> 
     ...
     */
    public static Supplier<CallMethodInstruction> PUSH_CHANNEL_USER_SLOT = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> PUSH_CHANNEL_USER_SORTEDSLOT = () ->
     ...
     */
    public static Supplier<CallMethodInstruction> PUSH_VARCLAN_ENABLED = () ->

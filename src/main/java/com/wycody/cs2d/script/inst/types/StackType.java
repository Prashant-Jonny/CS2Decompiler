...
public enum StackType {
	...
	/**
	 * Fake StackType for no stack operations. Use this or null.
	 */
	...
	public static StackType forType(String argTypeName) {
		for (StackType type : values())
			if (type.getGenericType().equalsIgnoreCase(argTypeName))
				return type;
		return null;
	}
